      ...
      <?php foreach ($categories as $c): ?>
        <tr>
          ...
          <td data-label="Actions">
            <div class="actions">
              <a class="btn btn-ghost btn-sm" href="?edit=<?= (int)$c['id'] ?>">Edit</a>
              <form method="post" onsubmit="return confirm('Delete this category?')"><?= csrf_field() ?><button class="btn btn-danger btn-sm" name="delete" value="<?= (int)$c['id'] ?>" type="submit">Delete</button></form>
            </div>
          </td>
        </tr>
      <?php endforeach; ?>
